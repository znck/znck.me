...
<template>
  <div>
    ...
    <nav
      ...
      role="navigation"
      class="flex flex-row justify-center pt-6 mb-4 pb-2 border-b border-solid"
    >
      <ul class="flex flex-row">
        <li class="mr-6 mb-4">
          <AppLink to="/" description="About me">About</AppLink>
        </li>
        <li class="mr-6 mb-4">
    ...
    <footer class="flex flex-col items-center mt-6 py-6 border-t border-solid">
      <h1 class="text-l mb-4" style="font-variant: small-caps">Connect with Me</h1>
      <!-- Social Media -->

      <nav aria-label="Social Media Navigation">
        <ul class="flex flex-row">
          <li class="mr-6">
            <AppLink to="https://twitter.com/@znck0" external description="Find me on Twitter as znck0">
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <li class="mr-6">
            <AppLink
              to="https://www.linkedin.com/in/rahulkadyan"
              external
              description="Find me on LinkedIn as rahulKadyan"
            >
              <svg
                aria-hidden="true"
                focusable="false"
          ...
          <li class="mr-6">
            <AppLink to="https://github.com/znck" external description="Find me on Github as znck">
              <svg
                aria-hidden="true"
                focusable="false"
                class="fill-current w-4 h-4 mr-1"
          ...
          <li>
            <AppLink to="https://keybase.io/znck" external description="Find me on keybase as znck">
              <svg
                aria-hidden="true"
                focusable="false"
                class="fill-current w-4 h-4 mr-1"
